...
object Support {
  ...
  /** Support rota entries.
    ...
    * entry lasts one week and the rota switches over at 11am.
    *
    * Entries are of the form: (year, month, day) -> ("support.user1",
    * "support.user2") Avoid leading zeroes on months and days. If only one
    * support user is known for the week, use tbd (no quotes) for the other.
    *
