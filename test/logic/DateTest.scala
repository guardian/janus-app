  ...
  "firstDayOfWeek" - {
    "returns monday for the example date" in {
      ...
      Date.firstDayOfWeek(date) shouldEqual ZonedDateTime
        .of(2015, 11, 2, 0, 0, 0, 0, ZoneOffset.UTC)
        .toInstant
    }
